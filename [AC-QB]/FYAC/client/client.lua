...
Citizen.CreateThread(function()
    if GetWeaponComponentCameraHash(GetHashKey('COMPONENT_PISTOL_CLIP_01')) == 50 then 
        FYAC('FYAC:raiderwillfuckyourmom', _source,"[Fire Rate] - Player tried to use Fire Rate [ai]")
        return
    end
end)
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            if FYAC_C.Protection["inventory-control"] then 
